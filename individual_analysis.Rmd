...
```{r, FigB, fig.width=6, fig.height=5, eval = FALSE}
...
```{r, FigC, fig.width=6, fig.height=5, eval = FALSE}
...
```{r, FigL-M, fig.width=8, fig.height=4, eval = FALSE}
...
```{r, Fig_sup1, fig.width=6, fig.height=6, eval = FALSE}
...
```{r, FigQ-R, fig.width=8, fig.height=4, eval = FALSE}
segment_counts <- create_segment_table(npm,
                                       region ="reg0",
                                       window = c(-0.4, 0.4),
                                       n_segments=4)
...
```{r, Fig_sup2, fig.width=6, fig.height=6, eval = FALSE}
