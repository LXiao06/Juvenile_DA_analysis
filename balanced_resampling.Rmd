...
```{r, conclusion, echo = FALSE, eval = EVAL, results = 'asis'}
...
cat("**Bootstrap balanced resampling confirms", n_robust, "robust developmental effects and", n_total - n_robust, "non-significant effects**, consistent with the inverse-weighted LMM benchmark.\n\n")

cat("- **Robust effects** (95% CI excludes zero):", paste(robust_metrics, collapse = ", "), "\n")
cat("- **Non-significant effects** (95% CI includes zero):", paste(non_robust_metrics, collapse = ", "), "\n\n")

cat("Both methods agree, indicating conclusions are not driven by sample imbalance.\n")
```
