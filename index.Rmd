...
# Or install local version
remotes::install_local("pkgs/VNS_0.0.0.9001.tar.gz", dependencies = TRUE)
```
...
- [Population Analysis](population_analysis.html)
    - [Weighted LMMs](weighted_LMMs.html)
    - [Balanced Resampling](balanced_resampling.html)
- [Photometry Modeling](photometry_modeling.html)
\
\
